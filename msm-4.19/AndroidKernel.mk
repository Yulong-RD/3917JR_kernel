...
ifneq ($(strip $(KERNEL_PRODUCT_NAME)),)
YL_PRODUCT_NAME := $(shell echo $(KERNEL_PRODUCT_NAME) | tr A-Z a-z)
endif
...
$(KERNEL_HEADERS_INSTALL): $(KERNEL_OUT)
	$(hide) if [ ! -z "$(KERNEL_HEADER_DEFCONFIG)" ]; then \
			...
			$(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_HEADER_ARCH) KBUILD_PRODUCT_NAME=$(YL_PRODUCT_NAME) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(real_cc) $(KERNEL_HEADER_DEFCONFIG); \
